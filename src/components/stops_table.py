...
class StopsTable(ft.Container):
    ...
    def __init__(self, width: int = 500, on_row_double_tap=None):
        ...
        table = ft.DataTable(
            columns=[
                ft.DataColumn(ft.Text("Line", size=12)),
                ft.DataColumn(
                    ft.Text("Issue", size=12),
                    heading_row_alignment=ft.MainAxisAlignment.CENTER,
                ),
                ft.DataColumn(
                    ft.Text("Stops", size=12),
                    heading_row_alignment=ft.MainAxisAlignment.CENTER,
                ),
                ft.DataColumn(
                    ft.Text("Downtime", size=12),
                    heading_row_alignment=ft.MainAxisAlignment.CENTER,
                ),
            ],
        ...
        content = ft.Column(
            [
                ft.Text("STOP DETAILS", size=12, weight=ft.FontWeight.BOLD),
                table_container,
            ],
                ...
                ft.DataRow(
                    cells=[
                        ...
                        ft.DataCell(
                            ft.GestureDetector(
                                content=ft.Container(
                                    content=ft.Text(str(issue), size=10),
                                    alignment=ft.alignment.center_left,
                        ...
                        ft.DataCell(
                            ft.GestureDetector(
                                content=ft.Container(
                                    content=ft.Text(str(stops), size=10),
                        ...
                        ft.DataCell(
                            ft.GestureDetector(
                                content=ft.Container(
                                    content=ft.Text(str(downtime), size=10),
                                    alignment=ft.alignment.center,
                                    padding=ft.padding.only(left=0),
                                ),
                                on_double_tap=lambda e,
